...
async function submitScore(){
  ...
  const submitUrl = getSubmitScoreUrl();
  try{ const res=await fetch(submitUrl,{method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify({player_name:playerName,score:submitScoreVal,level:submitLevelVal,time:submitTimeVal,game_duration:submitTimeVal})}); 
