![header-image](/images/blog/mlflow-and-wandb-tracking/mlflow_wandb.png)
...
![account_descr](/images/blog/mlflow-and-wandb-tracking/wandb_acc.png)
...
![account_descr](/images/blog/mlflow-and-wandb-tracking/wandb_api.png)
...
```bash
   mlflow run src/eda
```
![eda-cli](/images/blog/mlflow-and-wandb-tracking/eda_cli.png)

This will install Jupyter and all the dependencies for `pandas-profiling`, and open a Jupyter notebook instance.

![jup-nb](/images/blog/mlflow-and-wandb-tracking/jupyter-nb.png)

This is what the reports look like

![data-report](/images/blog/mlflow-and-wandb-tracking/datareport.png)

![data-report](/images/blog/mlflow-and-wandb-tracking/variables.png)
...
![header-image](/images/blog/mlflow-and-wandb-tracking/train_data_arte.png)

This shows the data lineage of the data
![header-image](/images/blog/mlflow-and-wandb-tracking/train_data_lineage.png)

This shows the model artifacts and parameter trained with it 
![header-image](/images/blog/mlflow-and-wandb-tracking/model_artefact.png)
Model params
![header-image](/images/blog/mlflow-and-wandb-tracking/model_params.png)

Here we have the runs metadata, the metrics from each run step
![header-image](/images/blog/mlflow-and-wandb-tracking/runs_data.png)
This shows the result from the runs
![header-image](/images/blog/mlflow-and-wandb-tracking/runs_ml.png)

MLflow also has a UI for recording runs metadata
![header-image](/images/blog/mlflow-and-wandb-tracking/mlflow_ui.png)

Here we have the runs for each step of the pipeline retraining process
![header-image](/images/blog/mlflow-and-wandb-tracking/mlflow_runs.png)
![header-image](/images/blog/mlflow-and-wandb-tracking/mlflow_run_metadata.png)

Here this the overview of the metadata for a run
![header-image](/images/blog/mlflow-and-wandb-tracking/overview_runs.png)
